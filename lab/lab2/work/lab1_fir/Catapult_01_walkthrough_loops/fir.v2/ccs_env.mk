ifeq "$(CXX_HOME)" ""
CXX_HOME                                              := /RAID2/cad/mentor/Catapult/2023.2/Mgc_home/pkgs/dcs_gcc/usr
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                              := gcc
...
ifeq "$(TCLSH_CMD)" ""
TCLSH_CMD                                             := /RAID2/cad/mentor/Catapult/2023.2/Mgc_home/bin/tclsh8.5
export TCLSH_CMD
endif
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                        := /usr/cad/mentor/Questa_Sim/2023.3_1/questasim/bin
...
Novas_NOVAS_INST_DIR                                  := /usr/cad/synopsys/verdi/2019.06
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                            := /usr/cad/mentor/Questa_Sim/2023.3_1/questasim/bin
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                             := 
